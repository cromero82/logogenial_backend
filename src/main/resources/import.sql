...
INSERT INTO usuario (id, activo, apellido, eliminado, email, estado, intentos_exitosos, intentos_fallidos, nombre, password, username, avatar) VALUES (4, true, 'admin', null, 'admin@mail.co', 1, 2, 0, 'admin', '$2a$10$pP9MI7Kg4FBGprc3BnuHFuKu6uUCY45ovz.TFgyhRp2CMsJEXV9xi', 'admin@mail.co','av-1.png');
